...
def fun1():
    ...
    os.chdir("../")
    print(os.getcwd())
    print(os.path.abspath("./")) # 返回目录的绝对路径
    print("-----------------------------------")
    print(os.path.basename("/home/haoside/test.py")) # 返回文件名
    os.chdir("OS")
    print(os.getcwd())
    print(os.path.dirname("/home/haoside/PycharmProjects/pythonProject/yy.py")) # 返回文件路径
