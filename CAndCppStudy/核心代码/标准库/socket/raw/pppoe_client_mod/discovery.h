 ...
 *----------------------------------------------*/
extern int get_ifindex(char *device_name);
...
extern void discovery (struct Connection_info *my_connection);
extern void session (struct Connection_info *my_connection);
