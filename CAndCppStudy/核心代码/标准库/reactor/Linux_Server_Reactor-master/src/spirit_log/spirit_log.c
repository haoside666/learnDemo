	...
	size_t funclen,long line,const char* format,...)
{
    ...
    switch(tag)
    {
    	case SLOG_LEVEL_DEBUG:
	    	...
	    	fprintf(debug_log_file, "[%s][%s] pid is [%d] filename is [%s],fun is [%s], at line[%ld] , debug_info: %s\n",__DATE__,__TIME__,getpid(),file, func,line,thread_buffer->msg_buf);
    	...
    	case SLOG_LEVEL_INFO:
	    	...
	    	fprintf(info_log_file, "[%s][%s] pid is [%d] filename is [%s],fun is [%s], at line [%ld] , info: %s",__DATE__,__TIME__,getpid(),file, func,line,
    	...
    	case SLOG_LEVEL_ERROR:
	    	...
	    	fprintf(error_log_file, "[%s][%s] pid is [%d] filename is [%s],fun is [%s], at line [%ld] , error_info: %s\n",__DATE__,__TIME__,getpid(),file, func,line,thread_buffer->msg_buf);
